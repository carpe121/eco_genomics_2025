...
# Define the path to popgenome folder

MYREPO="/gpfs1/home/m/c/mcarpen3/projects/eco_genomics_2025/population_genomics/"

# make a new directory within myresults/ to hold the fastp QC reports

mkdir ${MYREPO}/myresults/fastp_reports

# cd to the location where data for the Population Genomics module live:

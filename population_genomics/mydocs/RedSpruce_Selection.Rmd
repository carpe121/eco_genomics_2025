...
knitr::opts_knit$set(root.dir="~/projects/eco_genomics_2025/population_genomics/myresults/ANSD/PCA_Admix")
```
...
```{r}
allRScov <- as.matrix(read.table("RSBS_poly_K4.cov"))

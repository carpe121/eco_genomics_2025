...
ULT_trait <- read.csv("~/projects/eco_genomics_2025/transcriptomics/mydata/WGCNA_TraitData.csv", header = TRUE, stringsAsFactors = FALSE, row.names = 1)
...
20-24 are all acceptable powers, but 22 fits the best because it fits the best power line.
...
tonsa_go <- read.delim("~/projects/eco_genomics_2025/transcriptomics/mydata/Genes_GO_terms_output.tsv", header = TRUE) %>%

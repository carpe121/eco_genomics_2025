...
MYREPO="/users/m/c/mcarpen3/projects/eco_genomics_2025/transcriptomics"
...
NAME1=$(echo $READ1 | sed "s/_R1/_R1_clean_MHC/g")
NAME2=$(echo $READ2 | sed "s/_R2/_R2_clean_MHC/g")
